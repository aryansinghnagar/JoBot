...
_SECTION_HEADER_RE = re.compile(
    r"^(SUMMARY|PROFESSIONAL SUMMARY|EXECUTIVE SUMMARY|SKILLS|TECHNICAL SKILLS|CORE COMPETENCIES|WORK EXPERIENCE|EXPERIENCE|PROFESSIONAL EXPERIENCE|EMPLOYMENT HISTORY|EDUCATION|ACADEMIC BACKGROUND|PROJECTS|KEY PROJECTS|CERTIFICATIONS)\s*(SUMMARY)?$",
    re.IGNORECASE,
)
