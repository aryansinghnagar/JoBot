...
| 2026-07-22 15:03 | T1.13 | Wire AlertDispatcher into Subsystems | COMPLETED | `src/jobot/obs/alerts.py`, `src/jobot/stealth/circuit_breaker.py`, `src/jobot/policy/engine.py`, `src/jobot/cli/main.py`, `tests/test_alerts_wired.py` | `pytest tests/test_alerts_wired.py` passed 100%. Alerts persisted to `~/.jobot/alerts.jsonl`. `jobot alerts` command added. |
