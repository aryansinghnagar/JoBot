...
| 2026-07-22 15:00 | T1.6 | Wire TraceLogger into Pipeline Phases | COMPLETED | `src/jobot/obs/tracing.py`, `src/jobot/asp/pipeline.py`, `src/jobot/cli/main.py`, `tests/test_tracing_wired.py` | `pytest tests/test_tracing_wired.py` passed 100%. Spans persisted to `~/.jobot/traces/<run_id>.jsonl`. `jobot traces list` and `jobot traces show <run_id>` built. |
