...
| 2026-07-22 14:51 | T1.3 | Wire QAEngine into Pipeline Phase 4&5 | COMPLETED | `src/jobot/asp/pipeline.py`, `src/jobot/adapters/base.py`, `src/jobot/adapters/mock_ats.py`, `tests/test_qa_engine_wired.py` | `pytest tests/test_qa_engine_wired.py` passed 100%. Questions extracted, classified, grounded, and sensitive fields paused. |
