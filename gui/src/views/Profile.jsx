...
export function Profile({ rpc }) {
  ...
  const handleResumeSync = async (e) => {
    ...
    try {
      ...
      setSuccess(
        `Successfully imported resume. ${res.facts_seeded} truth facts recorded.`,
      );
      await loadData();
    } catch (err) {
  ...
  if (loading) {
    return (
      <section className="view">
        <p className="muted">Loading Candidate Truth Profile…</p>
      </section>
    );
  }
  ...
  return (
    <section className="view">
      <div className="view-header">
        ...
        <p className="muted">
          Your immutable, locally-encrypted ground truth facts. JoBot strictly
          validates all generated resumes, cover letters, and application
          answers against these facts.
        </p>
      </div>
      ...
      >
        ...
        <div className="card">
          ...
          {profile ? (
            <table style={{ width: "100%", fontSize: "0.95rem" }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {customAnswers["Target Titles"] || "Software Engineer"}
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    {compensation.minimum_annual_base_usd
                      ? `$${compensation.minimum_annual_base_usd.toLocaleString()}/yr`
                      : "Not specified"}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    {compensation.notice_period_days
                      ? `${compensation.notice_period_days} days`
                      : "30 days"}
                  </td>
                </tr>
              </tbody>
            ...
            <p className="muted">
              No encrypted profile found. Run Setup Wizard.
            </p>
          )}
        </div>
      ...
      <div className="card" style={{ marginBottom: "1.5rem" }}>
        ...
        <p className="muted">
          Explicitly certify a skill, degree, project, or custom form answer
          into your ledger.
        </p>
        <form
          className="form"
      ...
      <div className="card">
        ...
        {facts.length === 0 ? (
          <p className="muted">
            No candidate facts recorded yet in the truth store.
          </p>
        ) : (
          <table
            style={{
